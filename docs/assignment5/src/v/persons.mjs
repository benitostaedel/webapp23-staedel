...
updateFormEl.name.addEventListener("input", function () {
  updateFormEl.name.setCustomValidity( Person.checkName( updateFormEl.name.value).message);
});
...
updateFormEl["commit"].addEventListener("click", function () {
  ...
  updateFormEl.personId.setCustomValidity( // id check not strictly necessary because you cannot update the id
      Person.checkPersonIdAsId( slots.personId).message);
