...
/**
 *  Delete a person object/record
 *  Since the movie-person associations (director and actor(s) ) are both unidirectional, a linear search on all
 *  movies is required for being able to delete the person from the movies' director or actors.
 */
