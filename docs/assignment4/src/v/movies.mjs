...
import { fillSelectWithOptions, createListFromMap, createMultiSelectionWidget, createIsoDateString }
    from "../../lib/util.mjs";
...
createFormEl.releaseDate.addEventListener("input", function () {
  createFormEl.releaseDate.setCustomValidity( Movie.checkReleaseDate( createFormEl.releaseDate.valueAsDate).message);
});
...
updateFormEl.releaseDate.addEventListener("input", function () {
  updateFormEl.releaseDate.setCustomValidity( Movie.checkReleaseDate( updateFormEl.releaseDate.valueAsDate).message);
});
...
updateFormEl["commit"].addEventListener("click", function () {
  ...
  const slots = {
    ...
    releaseDate: updateFormEl["releaseDate"].valueAsDate,
